...
class GAN():
    ...
    def build_generator(self):
        ...
        model.add(ReLU())
        model.add(Conv2D(1024,(4,4),(2,2),padding='same'))
        model.add(ReLU())
        model.add(Conv2D(2048,(4,4),(2,2),padding='same'))
        model.add(ReLU())
        model.add(Flatten())
        ...
        model.add(Conv2DTranspose(2048,(4,4),(2,2),padding='same'))
        model.add(BatchNormalization())
        model.add(ReLU())
        model.add(Conv2DTranspose(1024,(4,4),(2,2),padding='same'))
        model.add(BatchNormalization())
        model.add(ReLU())
